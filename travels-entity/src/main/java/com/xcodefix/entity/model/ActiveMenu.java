...
public class ActiveMenu {
	...
	public String getSalesCustomer() {
		return salesCustomer;
	}
	public void setSalesCustomer(String salesCustomer) {
	...
	public String getTripSheet() {
		return tripSheet;
	}
	public void setTripSheet(String tripSheet) {
