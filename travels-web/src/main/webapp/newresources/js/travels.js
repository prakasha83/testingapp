function allLeadsTable() {
			...
			$( "#allLeadsTable" ).wrapAll("<div style='overflow-x:scroll;clear:both;width:100%' ></div>");
			new $.fn.dataTable.ColReorder(table);
			// color for table
			$( "#allLeadsTable_wrapper .top" ).append( "<span id='itsTxt' style='margin-top: 5px'>Travels List</span>" );

			// Reload every 5 min.
			leadReload = setInterval( function () {
				$('#allLeadsTable').DataTable().ajax.reload();
			}, 300000 );
